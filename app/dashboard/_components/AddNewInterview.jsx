...
function AddNewInterview() {
  ...
  const [bgImageUrl, setBgImageUrl] = useState("https://static.vecteezy.com/system/resources/thumbnails/026/323/748/small/a-white-chair-stands-in-a-white-room-near-the-window-photo.jpeg"); // Set default image URL
  const { user } = useUser();
    ...
    <div>
      ...
      <div
        ...
        style={{ 
          ...
          height: '200px', // Set a fixed height for the background image container
